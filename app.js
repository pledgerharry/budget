...
function renderInsights(){
  ...
  if(cc>0){
    insights.push({
      type:'info',
      icon:'📈',
      text:`The credit card is accruing ~£${interestThisMonth.toFixed(2)} in interest this month at 23.66% APR. The faster you pay it down, the less you'll lose to interest.`
    });
  }
  ...
  if(insights.length===0){
    insights.push({
      type:'info',
      icon:'📋',
      text:'Add some transactions and I'll give you personalised advice on your spending.'
    });
  }
